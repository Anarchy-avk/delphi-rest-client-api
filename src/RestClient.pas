...
begin
  Result := Post(Entity, TClass(Entity.ClassType));
end;
...
begin
  Result := Put(Entity, TClass(Entity.ClassType));
end;
...
begin
  Result := Patch(Entity, TClass(Entity.ClassType));
end;
...
begin
  ...
  if AnsiCompareStr(Field.FieldType.Name, TMultiPartFormAttachment.ClassName) = 0 then
  begin
